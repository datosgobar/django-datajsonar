...
class SynchronizerAdminTests(TestCase):
    ...
    def test_start_syncrhonizer_manually(self, mock_synchro):
        ...
        self.client.get(reverse('admin:django_datajsonar_synchronizer_start_synchro', args=(self.synchro.id,)))
    ...
    def test_start_manually_if_already_started_fails(self, mock_synchro):
        ...
        self.client.get(reverse('admin:django_datajsonar_synchronizer_start_synchro',
